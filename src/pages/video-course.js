              ...
              <div className="col-lg-8">
                <div className="single-course-box">
                  ...
                  <div className="product-single-top-part">
                    ...
                    <video id="videoPlayer" width="780" controls controlsList="nodownload" muted="muted" autoplay>
...
export default connect(mapStateToProps,mapDispatchToProps)(VideoCourse);
